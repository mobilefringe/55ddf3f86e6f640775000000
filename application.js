/*Created 2015-08-26  by Andy*/
    ...
    function drop_pin(id){
        ...
        map.setMarks([{ xy: [coords["x"] - 15 + x_offset, coords["y"] - 55 + y_offset],
                  attrs: {
                            src:  'http://assets.codecloudapp.com/sites/55ddf3f86e6f640775000000/image/png/1446761110000/pin.png'     // image for marker
                          }
                }
                ])
    }
    ...
    function get_date_string(start_date, end_date){
        start = new Date (start_date + "T05:00:00Z");
        end = new Date (end_date + "T05:00:00Z");
